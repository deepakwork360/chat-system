  ...
  return (
    <main className="min-h-screen w-full bg-background flex select-none font-sans overflow-hidden relative">
      ...
      <section className="hidden lg:flex lg:w-[45%] bg-card/40 border-r border-border/50 flex-col relative p-12 justify-between overflow-hidden backdrop-blur-xl">
        ...
        <div className="relative z-10 flex flex-col gap-1.5">
          <h2 className="text-xl font-bold tracking-tight text-foreground flex items-center gap-2">
            Next-Gen Workspace Chat
          </h2>
          <p className="text-xs text-muted-foreground leading-relaxed max-w-sm">
            Experience lightning-fast communication, read receipts, unread badges, group creation, and high-fidelity voice messages.
          </p>
        </div>
      </section>
      ...
      <section className="w-full lg:w-[55%] flex items-center justify-center p-6 sm:p-12 relative">
        <div className="w-full max-w-md flex flex-col gap-8 bg-card/40 backdrop-blur-2xl p-8 sm:p-10 rounded-3xl border border-border/50 shadow-2xl shadow-black/40">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              Enter your credentials to access your workspace conversations.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <Button
              type="submit"
              className="h-12 rounded-xl font-bold text-sm bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-600/90 text-primary-foreground shadow-lg shadow-primary/25 hover:shadow-primary/40 active:scale-[0.99] transition-all cursor-pointer mt-1"
              disabled={loading}
            >
              {loading ? (
                <>
